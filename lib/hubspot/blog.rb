module Hubspot
  ...
  class Blog
    ...
    class << self
      ...
      def find_by_id(id, opts = {})
        response = Hubspot::Connection.get_json(GET_BLOG_BY_ID_PATH, { blog_id: id }, opts)
        new(response)
      end
    end
    ...
    def posts(params = {}, opts = {})
      ...
      response = Hubspot::Connection.get_json(BLOG_POSTS_PATH, params, opts)
  ...
  class BlogPost
    ...
    def self.find_by_blog_post_id(id, opts = {})
      response = Hubspot::Connection.get_json(GET_BLOG_POST_BY_ID_PATH, { blog_post_id: id }, opts)
      new(response)
    end
