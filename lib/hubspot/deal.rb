...
module Hubspot
  ...
  class Deal
    ...
    class << self
      def create!(portal_id, company_ids, vids, params = {}, opts = {})
        ...
        response = Hubspot::Connection.post_json(CREATE_DEAL_PATH, {
                                                   params: {},
                                                   body: post_data
                                                 }, opts)
        new(response)
      ...
      def find(deal_id, opts = {})
        response = Hubspot::Connection.get_json(DEAL_PATH, { deal_id: deal_id }, opts)
        new(response)
      end
      ...
      def recent(params = {}, opts = {})
        response = Hubspot::Connection.get_json(RECENT_UPDATED_PATH, params, opts)
      ...
      def find_by_company(company, opts = {})
    ...
    def destroy!(opts = {})
      Hubspot::Connection.delete_json(DEAL_PATH, { deal_id: deal_id }, opts)
      @destroyed = true
    end
    ...
    def update!(params, opts = {})
      ...
      Hubspot::Connection.put_json(UPDATE_DEAL_PATH, {
