  ...
  class Contact
    ...
    class << self
      ...
      def all(params = {}, opts = {})
        ...
        recent_created = params.delete(:recent_created) { false }
        paged = params.delete(:paged) { false }
        path, params =
          if recent_created
            [RECENTLY_CREATED_PATH, Hubspot::ContactProperties.add_default_parameters(params)]
          elsif recent
            [RECENTLY_UPDATED_PATH, Hubspot::ContactProperties.add_default_parameters(params)]
          else
            [CONTACTS_PATH, params]
          end
      ...
      def createOrUpdate(email, params = {}, opts = {})
        post_data = { properties: Hubspot::Utils.hash_to_properties(params.stringify_keys) }
        response = Hubspot::Connection.post_json(CREATE_OR_UPDATE_PATH, {
      ...
      def search(query, params = {}, opts = {})
        ...
        response = Hubspot::Connection.get_json(QUERY_PATH, {
                                                  q: query,
                                                  count: count,
                                                  offset: offset
                                                }, opts)
    ...
    def update!(params, opts = {})
      ...
      Hubspot::Connection.post_json(UPDATE_CONTACT_PATH, {
    ...
    def destroy!(opts = {})
      Hubspot::Connection.delete_json(DESTROY_CONTACT_PATH, { contact_id: vid }, opts)
      @destroyed = true
    end
